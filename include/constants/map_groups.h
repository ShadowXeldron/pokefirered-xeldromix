...
#define MAP_COLOUR_DUNGEON_1F                    (123 | (1 << 8))
#define MAP_COLOUR_DUNGEON_ORANGE_TRIAL          (124 | (1 << 8))
#define MAP_COLOUR_DUNGEON_PURPLE_TRIAL          (125 | (1 << 8))
#define MAP_COLOUR_DUNGEON_GREEN_TRIAL           (126 | (1 << 8))
#define MAP_COLOUR_DUNGEON_PINK_TRIAL            (127 | (1 << 8))
#define MAP_COLOUR_DUNGEON_2F                    (128 | (1 << 8))
#define MAP_COLOUR_DUNGEON_RED_TRIAL             (129 | (1 << 8))
#define MAP_COLOUR_DUNGEON_BLUE_TRIAL            (130 | (1 << 8))
#define MAP_COLOUR_DUNGEON_3F                    (131 | (1 << 8))
#define MAP_COLOUR_DUNGEON_YELLOW_TRIAL          (132 | (1 << 8))
#define MAP_COLOUR_DUNGEON_SUMMIT                (133 | (1 << 8))
#define MAP_VIRIDIAN_FOREST_DEPTHS               (134 | (1 << 8))
#define MAP_VIRIDIAN_FOREST_GROTTO               (135 | (1 << 8))
...
#define MAP_ELEGANT_VALLEY_ENTRYWAY                   (60 | (2 << 8))
#define MAP_ELEGANT_VALLEY_HPAREA                     (61 | (2 << 8))
