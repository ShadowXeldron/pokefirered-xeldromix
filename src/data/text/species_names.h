const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_NINETALES] = _("Nintetales"),
    ...
    [SPECIES_AERODACTYL] = _("Aerodactly"),
    ...
    [SPECIES_MAGBY] = _("Magbu"),
    [SPECIES_MILTANK] = _("Militank"),
    [SPECIES_BLISSEY] = _("Blisset"),
    [SPECIES_RAIKOU] = _("Raikou"),
    [SPECIES_ENTEI] = _("Entei"),
    [SPECIES_SUICUNE] = _("Suicune"),
    [SPECIES_LARVITAR] = _("Larvitar"),
    [SPECIES_PUPITAR] = _("Pupirat"),
    [SPECIES_TYRANITAR] = _("Tyranitar"),
    [SPECIES_LUGIA] = _("Lugia"),
    [SPECIES_HO_OH] = _("Ho-oh"),
    [SPECIES_CELEBI] = _("Celebi"), // Celery sticks
    // Witness the random nonsense that came into my head
    [SPECIES_OLD_UNOWN_B] = _("Stove"),
    [SPECIES_OLD_UNOWN_C] = _("Dodongos"),
    [SPECIES_OLD_UNOWN_D] = _("Why"),
    [SPECIES_OLD_UNOWN_E] = _("Jeff Bezos"),
    [SPECIES_OLD_UNOWN_F] = _("CoroCoro"),
    [SPECIES_OLD_UNOWN_G] = _("CarInsurance"),
    [SPECIES_OLD_UNOWN_H] = _("FTP"),
    [SPECIES_OLD_UNOWN_I] = _("Waifu"),
    [SPECIES_OLD_UNOWN_J] = _("Iron Mugulis"),
    [SPECIES_OLD_UNOWN_K] = _("Hacker"),
    [SPECIES_OLD_UNOWN_L] = _("Donkeh"),
    [SPECIES_OLD_UNOWN_M] = _("Yee"),
    [SPECIES_OLD_UNOWN_N] = _("MM8>MM2"),
    [SPECIES_OLD_UNOWN_O] = _("Nudiga"),
    [SPECIES_OLD_UNOWN_P] = _("Hooha"),
    [SPECIES_OLD_UNOWN_Q] = _("Hooves"),
    [SPECIES_OLD_UNOWN_R] = _("Henry"),
    [SPECIES_OLD_UNOWN_S] = _("M. Bison"),
    [SPECIES_OLD_UNOWN_T] = _("The Clangers"),
    [SPECIES_OLD_UNOWN_U] = _("Legends 3"),
    [SPECIES_OLD_UNOWN_V] = _("Barbenheimer"),
    [SPECIES_OLD_UNOWN_W] = _("BanjoThreeie"),
    [SPECIES_OLD_UNOWN_X] = _("Twitter"),
    [SPECIES_OLD_UNOWN_Y] = _("Minecraft"),
    [SPECIES_OLD_UNOWN_Z] = _("Silksong"),
