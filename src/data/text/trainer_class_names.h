const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_RS_AROMA_LADY]       = _("Auroma Lady"),
    [TRAINER_CLASS_RS_RUIN_MANIAC]      = _("Ruin Maniac"),
    [TRAINER_CLASS_INTERVIEWER]         = _("Interviewer"),
    [TRAINER_CLASS_RS_TUBER_F]          = _("Tuber"),
    [TRAINER_CLASS_RS_TUBER_M]          = _("Tubr"),
    [TRAINER_CLASS_RS_COOLTRAINER]      = _("Ace Trainer"),
    ...
    [TRAINER_CLASS_RS_SIS_AND_BRO]      = _("Sis & Bro"),
    ...
    [TRAINER_CLASS_CUE_BALL]            = _("Roughneck"),
