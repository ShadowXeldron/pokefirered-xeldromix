...
static const u8 sWonderGuardDescription[] = _("Only supereffective will hit.");
...
static const u8 sTriageDescription[] = _("Gives priority to healing moves");
static const u8 sPranksterDescription[] = _("Gives priority to a status move");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_BATTLE_ARMOR] = _("BattleArmour"),
    ...
    [ABILITY_CACOPHONY] = _("You Cheater!"), // Cacophony is unobtainable. Granted, due to the way that Gen 3 handles abilities you won't even be able to put Cacophony on anything.
