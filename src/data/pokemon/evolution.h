const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            {EVO_ITEM, ITEM_METAL_COAT, SPECIES_GLACEON}, // Placeholder until I add the Dawn Stone
                            {EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_SYLVEON}}, // Placeholder until I add the Shiny Stone
    ...
    [SPECIES_KIRLIA]     = {{EVO_LEVEL, 30, SPECIES_GARDEVOIR}},
                            {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_GALLADE}}, // Change this to the Dawn Stone when it's added
    [SPECIES_BAGON]      = {{EVO_LEVEL, 30, SPECIES_SHELGON}},
    [SPECIES_SHELGON]    = {{EVO_LEVEL, 50, SPECIES_SALAMENCE}},
    [SPECIES_BELDUM]     = {{EVO_LEVEL, 20, SPECIES_METANG}},
    [SPECIES_METANG]     = {{EVO_LEVEL, 45, SPECIES_METAGROSS}},
    // New guys that aren't already on the list
    [SPECIES_MISDREAVUS] = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_MISMAGIUS}}, // Swap the Moon Stone for the Dusk Stone if I add it
    [SPECIES_SNEASEL]    = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_WEAVILE}}, // Swap for Dusk Stone
    [SPECIES_PRIMEAPE]   = {{EVO_LEVEL, 36, SPECIES_ANNIHLAPE}}, // 36 is one level after it learns Rage Fist in SV
    ...
    [SPECIES_RHYDON]     = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_RHYPERIOR}},
    [SPECIES_PORYGON2]   = {{EVO_ITEM, ITEM_UP_GRADE, SPECIES_PORYGONZ}},
    [SPECIES_HAPPINY]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_CHANSEY}}, // Placeholder functionality since I don't want to add Oval Stones
    //[SPECIES_HAPPINY]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_PORYGONZ}},
