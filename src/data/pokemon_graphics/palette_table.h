const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(HAPPINY, gMonPalette_Vileplume),
    SPECIES_PAL(LICKILICKY, gMonPalette_Vileplume),
    SPECIES_PAL(RHYPERIOR, gMonPalette_Vileplume),
    SPECIES_PAL(TANGROWTH, gMonPalette_Vileplume),
    SPECIES_PAL(MIME_JR, gMonPalette_Vileplume),
    SPECIES_PAL(ELECTIVIRE, gMonPalette_Vileplume),
    SPECIES_PAL(MAGMORTAR, gMonPalette_Vileplume),
    SPECIES_PAL(GLACEON, gMonPalette_Vileplume),
    SPECIES_PAL(LEAFEON, gMonPalette_Vileplume),
    SPECIES_PAL(SYLVEON, gMonPalette_Vileplume),
    SPECIES_PAL(PORYGONZ, gMonPalette_Vileplume),
    SPECIES_PAL(MUNCHLAX, gMonPalette_Vileplume),
    SPECIES_PAL(TOGEKISS, gMonPalette_Vileplume),
    SPECIES_PAL(BONSLY, gMonPalette_Vileplume),
    SPECIES_PAL(MAGNEZONE, gMonPalette_Vileplume),
    SPECIES_PAL(AMBIPOM, gMonPalette_Vileplume),
    SPECIES_PAL(MISMAGIUS, gMonPalette_Vileplume),
    SPECIES_PAL(GLISCOR, gMonPalette_Vileplume),
    SPECIES_PAL(WEAVILE, gMonPalette_Vileplume),
    SPECIES_PAL(MANTYKE, gMonPalette_Vileplume),
    SPECIES_PAL(MAMOSWINE, gMonPalette_Vileplume),
    SPECIES_PAL(GALLADE, gMonPalette_Vileplume),
    SPECIES_PAL(PROBOPASS, gMonPalette_Vileplume),
    SPECIES_PAL(CHINGLING, gMonPalette_Vileplume),
    SPECIES_PAL(FROSLASS, gMonPalette_Vileplume),
    SPECIES_PAL(BUDEW, gMonPalette_Vileplume),
    SPECIES_PAL(YANMEGA, gMonPalette_Vileplume),
    SPECIES_PAL(HONCHKROW, gMonPalette_Vileplume),
    SPECIES_PAL(ANNIHLAPE, gMonPalette_Vileplume),
    SPECIES_PAL(KLEAVOR, gMonPalette_Vileplume),
    SPECIES_PAL(FARIGIRAF, gMonPalette_Vileplume),
    SPECIES_PAL(DUDUNSPARSE, gMonPalette_Vileplume),
    SPECIES_PAL(URSALUNA, gMonPalette_Vileplume),
    SPECIES_PAL(WYRDEER, gMonPalette_Vileplume),
    SPECIES_PAL(ROSERADE, gMonPalette_Vileplume),
};
