const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(HAPPINY, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(LICKILICKY, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(RHYPERIOR, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(TANGROWTH, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(MIME_JR, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(ELECTIVIRE, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(MAGMORTAR, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(GLACEON, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(LEAFEON, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(SYLVEON, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(PORYGONZ, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(MUNCHLAX, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(TOGEKISS, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(BONSLY, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(MAGNEZONE, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(AMBIPOM, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(MISMAGIUS, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(GLISCOR, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(WEAVILE, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(MANTYKE, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(MAMOSWINE, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(GALLADE, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(PROBOPASS, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(CHINGLING, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(FROSLASS, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(BUDEW, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(YANMEGA, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(HONCHKROW, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(ANNIHLAPE, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(KLEAVOR, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(FARIGIRAF, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(DUDUNSPARSE, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(URSALUNA, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(WYRDEER, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(ROSERADE, gMonShinyPalette_Metapod),
};
