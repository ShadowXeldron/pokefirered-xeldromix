const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    // Newmons laziliy copied from front_pic_table
    // NOTE TO SELF: Add actual sprites

    SPECIES_SPRITE(HAPPINY, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(LICKILICKY, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(RHYPERIOR, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(TANGROWTH, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(MIME_JR, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(ELECTIVIRE, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(MAGMORTAR, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(GLACEON, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(LEAFEON, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(SYLVEON, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(PORYGONZ, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(MUNCHLAX, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(TOGEKISS, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(BONSLY, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(MAGNEZONE, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(AMBIPOM, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(MISMAGIUS, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(GLISCOR, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(WEAVILE, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(MANTYKE, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(MAMOSWINE, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(GALLADE, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(PROBOPASS, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(CHINGLING, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(FROSLASS, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(BUDEW, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(YANMEGA, gMonFrontPic_UnownQuestionMark),
    SPECIES_SPRITE(HONCHKROW, gMonFrontPic_UnownQuestionMark),
