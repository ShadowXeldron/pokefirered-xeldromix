const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_HAPPINY] = gMonFootprint_Bulbasaur,
    [SPECIES_LICKILICKY] = gMonFootprint_Bulbasaur,
    [SPECIES_RHYPERIOR] = gMonFootprint_Bulbasaur,
    [SPECIES_TANGROWTH] = gMonFootprint_Bulbasaur,
    [SPECIES_MIME_JR] = gMonFootprint_Bulbasaur,
    [SPECIES_ELECTIVIRE] = gMonFootprint_Bulbasaur,
    [SPECIES_MAGMORTAR] = gMonFootprint_Bulbasaur,
    [SPECIES_GLACEON] = gMonFootprint_Bulbasaur,
    [SPECIES_LEAFEON] = gMonFootprint_Bulbasaur,
    [SPECIES_SYLVEON] = gMonFootprint_Bulbasaur,
    [SPECIES_PORYGONZ] = gMonFootprint_Bulbasaur,
    [SPECIES_MUNCHLAX] = gMonFootprint_Bulbasaur,
    [SPECIES_TOGEKISS] = gMonFootprint_Bulbasaur,
    [SPECIES_BONSLY] = gMonFootprint_Bulbasaur,
    [SPECIES_MAGNEZONE] = gMonFootprint_Bulbasaur,
    [SPECIES_AMBIPOM] = gMonFootprint_Bulbasaur,
    [SPECIES_MISMAGIUS] = gMonFootprint_Bulbasaur,
    [SPECIES_GLISCOR] = gMonFootprint_Bulbasaur,
    [SPECIES_WEAVILE] = gMonFootprint_Bulbasaur,
    [SPECIES_MANTYKE] = gMonFootprint_Bulbasaur,
    [SPECIES_MAMOSWINE] = gMonFootprint_Bulbasaur,
    [SPECIES_GALLADE] = gMonFootprint_Bulbasaur,
    [SPECIES_PROBOPASS] = gMonFootprint_Bulbasaur,
    [SPECIES_CHINGLING] = gMonFootprint_Bulbasaur,
    [SPECIES_FROSLASS] = gMonFootprint_Bulbasaur,
    [SPECIES_BUDEW] = gMonFootprint_Bulbasaur,
    [SPECIES_YANMEGA] = gMonFootprint_Bulbasaur,
    [SPECIES_HONCHKROW] = gMonFootprint_Bulbasaur,
    [SPECIES_ANNIHLAPE] = gMonFootprint_Bulbasaur,
    [SPECIES_KLEAVOR] = gMonFootprint_Bulbasaur,
    [SPECIES_FARIGIRAF] = gMonFootprint_Bulbasaur,
    [SPECIES_DUDUNSPARSE] = gMonFootprint_Bulbasaur,
    [SPECIES_URSALUNA] = gMonFootprint_Bulbasaur,
    [SPECIES_WYRDEER] = gMonFootprint_Bulbasaur,
    [SPECIES_ROSERADE] = gMonFootprint_Bulbasaur,
