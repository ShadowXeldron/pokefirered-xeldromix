...
const u8 gMoveDescription_NightSlash[] = _("The user slashes the target the instant an opportunity arises. It has a high critical-hit ratio. ");
const u8 gMoveDescription_Snarl[] = ("The user yells as if it is ranting about something, making the target's Sp. Atk stat decrease.");
const u8 gMoveDescription_BulletPunch[] = ("The user strikes the target with tough punches as fast as bullets. This move always goes first. ");
const u8 gMoveDescription_IronHead[] = ("The foe slams the target with its steel-hard head. It may also make the target flinch.");
const u8 gMoveDescription_StoneEdge[] = ("The user stabs the foe with a sharpened stone. It has a high critical-hit ratio.");
const u8 gMoveDescription_AquaJet[] = ("The user lunges at the foe at a speed that makes it almost invisible. It is sure to strike first.");
const u8 gMoveDescription_IceShard[] = ("The user flash freezes chunks of ice and hurls them. This move always goes first.");
const u8 gMoveDescription_BraveBird[] = ("The user tucks in its wings and charges from a low altitude. The user also takes serious damage. ");
const u8 gMoveDescription_FlameTail[] = ("Singes the target with a blazing tail. It may also\nlower the foe's\nSP. DEF stat.");
const u8 gMoveDescription_ShellShock[] = ("The foe is blasted by the user's cannons for for two\nto five turns.");
const u8 gMoveDescription_PoisonIvy[] = ("The user surrounds the target with venomous vines. It may poison\nthe foe.");
const u8 gMoveDescription_QuadraSlam[] = ("Using its four arms, the user pummels the foe two to five\ntimes.");
const u8 gMoveDescription_Extinction[] = ("The user unleashes primal power to to inflict severe\ndamage, even\nmaking itself faint.");
const u8 gMoveDescription_CloseCombat[] = ("The user fights the foe in close without guarding itself. It also cuts the user's Defense and Sp. Def.");
const u8 gMoveDescription_DragonAscent[] = ("The user attacks the target by dropping out of the sky at high speed. This also lowers the user's Defense and Sp. Def stats.");
const u8 gMoveDescription_HeadlongRush[] = ("The user smashes into the target in a full-body tackle. This also lowers the user’s Defense and Sp. Def stats.");
