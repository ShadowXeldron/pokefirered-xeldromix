...
const u8 gMoveDescription_AirSlash[] = _("Desc Here");
const u8 gMoveDescription_AquaTail[] = _("Desc Here");
const u8 gMoveDescription_AuraSphere[] = _("Desc Here");
const u8 gMoveDescription_Discharge[] = _("Desc Here");
const u8 gMoveDescription_DoubleHit[] = _("Desc Here");
const u8 gMoveDescription_DrainPunch[] = _("Desc Here");
