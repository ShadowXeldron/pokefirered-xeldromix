...
const u8 gMoveDescription_CrossPoison[] = _("A toxic slash with\na high critical-hit\nratio. It may also\npoison the foe.");
const u8 gMoveDescription_PoisonJab[] = _("The foe is stabbed with\na poisonous arm\n. It may also\n poison the foe.");
const u8 gMoveDescription_GunkShot[] = _("The user shoots filth\n at the foe to attack.\n It may also\n poison the foe.");
const u8 gMoveDescription_BugBuzz[] = _("The user rubs its wings\nto make a damaging sound wave.\n It may also lower\n the foe's Def stat.");
const u8 gMoveDescription_XScissor[] = _("A toxic slash with\na high critical-hit\nratio. It may also\npoison the foe.");
const u8 gMoveDescription_Infestation[] = _("The target is infested\n for two to five turns.\nThe target can't flee\n during this time.");
const u8 gMoveDescription_StruggleBug[] = _("While resisting, the\n user attacks the opponent.\n The targets' Sp. Atk\nis also reduced.");
const u8 gMoveDescription_DracoMeteor[] = _("Comets are summoned\ndown from the sky.\nThe attack also sharply\nreduces the user's Sp. Atk.");
const u8 gMoveDescription_DragonRush[] = _("The user tackles the\nfoe while exhibiting\nmenace. It may also\n make the target flinch.");
const u8 gMoveDescription_DragonPulse[] = _("The foe is attacked\nwith a shockwave\ngenerated by the user's\ngaping mouth.");
const u8 gMoveDescription_ShadowSneak[] = _(" The user extends its\nshadow and attacks the\nfoe from behind.\nThis move always goes first.");
const u8 gMoveDescription_OminousWind[] = _("The user creates a\ngust of repulsive wind.\nIt may raise all\nthe user's stats.");
const u8 gMoveDescription_ShadowClaw[] = _("The user slashes with\na sharp claw made from shadows.\nIt has a high\ncritical-hit ratio.");
const u8 gMoveDescription_DarkPulse[] = _("The user releases a\nhorrible aura imbued with\n dark thoughts. It may also\n make the target flinch.");
const u8 gMoveDescription_NightSlash[] = _("The user slashes\nthe target the instant an opportunity arises. It has a high critical-hit ratio. ");
const u8 gMoveDescription_Snarl[] = _("The user yells as if it is ranting about something, making the target's Sp. Atk stat decrease.");
const u8 gMoveDescription_BulletPunch[] = _("The user strikes the target with tough punches as fast as bullets. This move always goes first. ");
const u8 gMoveDescription_IronHead[] = _("The foe slams the target with its steel-hard head. It may also make the target flinch.");
const u8 gMoveDescription_StoneEdge[] = _("The user stabs the foe with a sharpened stone. It has a high critical-hit ratio.");
const u8 gMoveDescription_IceShard[] = _("The user flash freezes chunks of ice and hurls them. This move always goes first.");
const u8 gMoveDescription_AquaJet[] = _("The user lunges at the foe at a speed that makes it almost invisible. It is sure to strike first.");
const u8 gMoveDescription_BraveBird[] = _("The user tucks in its wings and charges from a low altitude. The user also takes serious damage. ");
const u8 gMoveDescription_FlameTail[] = _("Singes the target with a blazing tail. It may also\nlower the foe's\nSP. DEF stat.");
const u8 gMoveDescription_ShellShock[] = _("The foe is blasted by the user's cannons for for two\nto five turns.");
const u8 gMoveDescription_PoisonIvy[] = _("The user surrounds the target with venomous vines. It may poison\nthe foe.");
const u8 gMoveDescription_QuadraSlam[] = _("Using its four arms, the user pummels the foe two to five\ntimes.");
const u8 gMoveDescription_Extinction[] = _("The user unleashes primal power to to inflict severe\ndamage, even\nmaking itself faint.");
const u8 gMoveDescription_CloseCombat[] = _("The user fights the foe in close without guarding itself. It also cuts the user's Defense and Sp. Def.");
const u8 gMoveDescription_DragonAscent[] = _("The user attacks the target by dropping out of the sky at high speed. This also lowers the user's Defense and Sp. Def stats.");
const u8 gMoveDescription_HeadlongRush[] = _("The user smashes into the target in a full-body tackle. This also lowers the user’s Defense and Sp. Def stats.");
const u8 gMoveDescription_AirSlash[] = _("30 percent flinch chance");
const u8 gMoveDescription_AquaTail[] = _("No side effects");
const u8 gMoveDescription_AuraSphere[] = _("Never misses");
const u8 gMoveDescription_Discharge[] = _("30 percent paralysis chance");
const u8 gMoveDescription_DoubleHit[] = _("Hits twice");
const u8 gMoveDescription_DrainPunch[] = _("Restores 50 percent of the attack's damage");
const u8 gMoveDescription_EarthPower[] = _("Desc Here");
const u8 gMoveDescription_EnergyBall[] = _("Desc Here");
...
const u8 gMoveDescription_IceFang[] = _("Desc Here");
const u8 gMoveDescription_LavaPlume[] = _("Desc Here");
const u8 gMoveDescription_MagnetBomb[] = _("Desc Here");
const u8 gMoveDescription_MirrorShot[] = _("Desc Here");
const u8 gMoveDescription_MudBomb[] = _("Desc Here");
const u8 gMoveDescription_NastyPlot[] = _("Desc Here");
const u8 gMoveDescription_PowerGem[] = _("Desc Here");
const u8 gMoveDescription_PowerWhip[] = _("Desc Here");
const u8 gMoveDescription_PsychoCut[] = _("Desc Here");
const u8 gMoveDescription_RockClimb[] = _("Desc Here");
const u8 gMoveDescription_SeedBomb[] = _("Desc Here");
const u8 gMoveDescription_ThunderFang[] = _("Desc Here");
const u8 gMoveDescription_WoodHammer[] = _("Desc Here");
const u8 gMoveDescription_Bulldoze[] = _("Desc Here");
const u8 gMoveDescription_DrillRun[] = _("Desc Here");
const u8 gMoveDescription_DualChop[] = _("Desc Here");
const u8 gMoveDescription_Electroweb[] = _("Desc Here");
const u8 gMoveDescription_IcicleCrash[] = _("Desc Here");
const u8 gMoveDescription_Inferno[] = _("Desc Here");
const u8 gMoveDescription_LeafTornado[] = _("Desc Here");
const u8 gMoveDescription_LowSweep[] = _("Desc Here");
const u8 gMoveDescription_RazorShell[] = _("Desc Here");
const u8 gMoveDescription_Scald[] = _("Desc Here");
const u8 gMoveDescription_SludgeWave[] = _("Desc Here");
const u8 gMoveDescription_WildCharge[] = _("Desc Here");
const u8 gMoveDescription_Boomburst[] = _("Desc Here");
const u8 gMoveDescription_MysticalFire[] = _("Desc Here");
const u8 gMoveDescription_Nuzzle[] = _("Desc Here");
const u8 gMoveDescription_PetalBlizzard[] = _("Desc Here");
const u8 gMoveDescription_PhantomForce[] = _("Desc Here");
const u8 gMoveDescription_PowerUpPunch[] = _("Desc Here");
const u8 gMoveDescription_PrecipiceBlades[] = _("Desc Here");
const u8 gMoveDescription_OriginPulse[] = _("Desc Here");
const u8 gMoveDescription_HighHorsepower[] = _("Desc Here");
const u8 gMoveDescription_Liquidation[] = _("Desc Here");
const u8 gMoveDescription_Lunge[] = _("Desc Here");
const u8 gMoveDescription_PsychicFangs[] = _("Desc Here");
const u8 gMoveDescription_DualWingbeat[] = _("Desc Here");
const u8 gMoveDescription_RagingFury[] = _("Desc Here");
const u8 gMoveDescription_TripleAxel[] = _("Desc Here");
const u8 gMoveDescription_AquaCutter[] = _("Desc Here");
const u8 gMoveDescription_ChillingWater[] = _("Desc Here");
const u8 gMoveDescription_Pounce[] = _("Desc Here");
const u8 gMoveDescription_BabyDollEyes[] = _("Desc Here");
const u8 gMoveDescription_DazzlingGleam[] = _("Desc Here");
const u8 gMoveDescription_DisarmingVoice[] = _("Desc Here");
const u8 gMoveDescription_DrainingKiss[] = _("Desc Here");
const u8 gMoveDescription_FairyWind[] = _("Desc Here");
const u8 gMoveDescription_Moonblast[] = _("Desc Here");
const u8 gMoveDescription_PlayRough[] = _("Desc Here");
const u8 gMoveDescription_PsychoForce[] = _("Desc Here");
const u8 gMoveDescription_WaveCrash[] = _("Desc Here");
const u8 gMoveDescription_Paradox[] = _("Desc Here");
const u8 gMoveDescription_AfterBurner[] = _("Desc Here");
const u8 gMoveDescription_Landslide[] = _("Desc Here");
const u8 gMoveDescription_TrioTunnel[] = _("Desc Here");
const u8 gMoveDescription_Brainstorm[] = _("Desc Here");
const u8 gMoveDescription_Hurricane[] = _("Desc Here");
const u8 gMoveDescription_SmartStrike[] = _("Desc Here");
const u8 gMoveDescription_RockWrecker[] = _("Desc Here");
const u8 gMoveDescription_BouncyBubble[] = _("Desc Here");
const u8 gMoveDescription_BuzzyBuzz[] = _("Desc Here");
const u8 gMoveDescription_SizzlySlide[] = _("Desc Here");
const u8 gMoveDescription_GlitzyGlow[] = _("Desc Here");
const u8 gMoveDescription_BaddyBad[] = _("Desc Here");
const u8 gMoveDescription_SappySeed[] = _("Desc Here");
const u8 gMoveDescription_FreezyFrost[] = _("Desc Here");
const u8 gMoveDescription_SparklySwirl[] = _("Desc Here");
const u8 gMoveDescription_RageFist[] = _("Desc Here");
const u8 gMoveDescription_SuckerPunch[] = _("Desc Here");
const u8 gMoveDescription_QuiverDance[] = _("Desc Here");
const u8 gMoveDescription_TwinBeam[] = _("Desc Here");
const u8 gMoveDescription_HyperDrill[] = _("Desc Here");
const u8 gMoveDescription_SacredSword[] = _("Desc Here");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_FLAME_TAIL    - 1] = gMoveDescription_FlameTail,
    [MOVE_SHELL_SHOCK   - 1] = gMoveDescription_ShellShock,
    [MOVE_POISON_IVY    - 1] = gMoveDescription_PoisonIvy,
    [MOVE_QUADRA_SLAM   - 1] = gMoveDescription_QuadraSlam,
    [MOVE_EXTINCTION    - 1] = gMoveDescription_Extinction,
    ...
    [MOVE_PSYCHO_FORCE  - 1] = gMoveDescription_PsychoForce,
    [MOVE_HURRICANE     - 1] = gMoveDescription_Hurricane,
    [MOVE_AFTER_BURNER  - 1] = gMoveDescription_AfterBurner,
    [MOVE_LANDSLIDE     - 1] = gMoveDescription_Landslide,
    [MOVE_TRIO_TUNNEL   - 1] = gMoveDescription_TrioTunnel,
    [MOVE_BRAINSTORM    - 1] = gMoveDescription_Brainstorm,
