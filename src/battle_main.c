...
const u8 gTypeEffectiveness[372] =
{
    ...
    TYPE_WATER, TYPE_ICE, TYPE_MUL_NOT_EFFECTIVE, // New for Xeldromix
    ...
    TYPE_DRAGON, TYPE_ICE, TYPE_MUL_NOT_EFFECTIVE, // New for Xeldromix
    ...
    TYPE_BUG, TYPE_FAIRY, TYPE_MUL_SUPER_EFFECTIVE, // Is MUL_NOT_EFFECTIVE in the official games, but Fairies are kind of OP and Bug is just bad offensively
